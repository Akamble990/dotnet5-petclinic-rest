...
namespace PetClinic.Api.Controllers
{
    ...
    public class PetTypeRestController : ControllerBase
    {
        ...
        public virtual async Task<ActionResult<List<PetTypeDTO>>> getAllPetTypes(CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult<PetTypeDTO>> getPetType([FromRoute] int petTypeId, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult<int>> addPetType([FromBody] PetTypeDTO dto, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> updatePetType([FromRoute] int petTypeId, [FromBody] PetTypeDTO dto, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> deletePetType([FromRoute] int petTypeId, CancellationToken cancellationToken)
        {
