...
namespace PetClinic.Api.Controllers
{
    ...
    public class VisitRestController : ControllerBase
    {
        ...
        public virtual async Task<ActionResult<VisitDTO>> getVisit([FromRoute] int visitId, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> addVisit([FromBody] VisitCreateDTO dto, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> updateVisit([FromRoute] int visitId, [FromBody] VisitUpdateDTO dto, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> deleteVisit([FromRoute] int visitId, CancellationToken cancellationToken)
        {
