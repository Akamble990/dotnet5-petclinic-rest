...
namespace PetClinic.Api.Controllers
{
    ...
    public class VetRestController : ControllerBase
    {
        ...
        public virtual async Task<ActionResult<List<VetDTO>>> getAllVets(CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult<VetDTO>> getVet([FromRoute] int vetId, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> addVet([FromBody] VetCreateDTO dto, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> updateVet([FromRoute] int vetId, [FromBody] VetUpdateDTO dto, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> deleteVet([FromRoute] int vetId, CancellationToken cancellationToken)
        {
