...
namespace PetClinic.Api.Controllers
{
    ...
    public class PetRestController : ControllerBase
    {
        ...
        public virtual async Task<ActionResult<PetDTO>> getPet([FromRoute] int petId, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> addPet([FromBody] PetCreateDTO dto, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> updatePet([FromRoute] int petId, [FromBody] PetUpdateDTO dto, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public virtual async Task<ActionResult> deletePet([FromRoute] int petId, CancellationToken cancellationToken)
        {
